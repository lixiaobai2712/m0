...
def build_hardware_prompt_context(
    ...
    *,
    ...
    if normalized_profile == "mspm0_line_follow_car":
        context.update({
            "control_domain": "line_follow",
            "sensor_layout_right_to_left": "PB25 PB18 PA30 PB0 PB1 PB10 PB11 PB14",
            "sensor_positions": "+120 +85 +55 +20 -20 -55 -85 -120",
            "black_line_level": "high",
            "lost_line_encoding": "+/-110",
            "pwm_field_note": "Signed differential motor correction, not absolute motor PWM.",
            "safety_priority": "Any line loss is unacceptable; then minimize edge hits and oscillation.",
            "tuning_guidance": (
                "Use small changes. Keep I at zero or very small unless persistent bias is proven. "
                "Never trade line loss for lower average error."
            ),
            "per_round_guardrail_hint": "P/I/D may increase by at most 1.25x per round.",
        })
