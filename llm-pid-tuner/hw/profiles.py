...
_PROFILE_ALIASES = {
    ...
    "line_follow": "mspm0_line_follow_car",
    "line_follow_car": "mspm0_line_follow_car",
    "mspm0_line_follow_car": "mspm0_line_follow_car",
}

_PROFILE_INFO: Dict[str, Dict[str, Any]] = {
    "mspm0_line_follow_car": {
        "board_family": "mspm0",
        "note": (
            "Eight-channel digital line-following car. Setpoint is 0; input is "
            "signed line position from -100 to +100, and +/-110 means line lost. "
            "PWM is signed differential correction. Prioritize zero line loss and "
            "low oscillation over response speed."
        ),
        "controller_count": 1,
        "vision_center": None,
    },
...
def get_hardware_sample_format_hint(profile: Any) -> str:
    ...
    if normalized == "mspm0_line_follow_car":
        return "CSV rows: timestamp,0,line_position,differential_correction,error,p,i,d,running"
